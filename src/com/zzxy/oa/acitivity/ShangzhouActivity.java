 ...
 */
public class ShangzhouActivity extends Activity {
	...
	private  class  kaoqinThread extends Thread {
		...
		public void run() {
			showDialog(0);
			kaoqinList = HttpConnectUtil.findKaoQinList(getUserName(),"lastweek");
			if (kaoqinList == null) {
	...
	private Handler hander = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case NET_ERROR:
				...
				dismissDialog(0);
				Toast.makeText(ShangzhouActivity.this, "网络连接超时", 1000).show();
				break;
			case DATA_EMPTY:
				dismissDialog(0);
				weekWiew.setVisibility(View.GONE);
				kaoqinView.setVisibility(View.GONE);
				Toast.makeText(ShangzhouActivity.this, "服务器没有返回数据，请重试！", 1000).show();
				break;
			case DATA_SUCCESS:
